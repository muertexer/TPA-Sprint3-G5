...
from PyQt6.QtWidgets import QAbstractItemView, QApplication, QHBoxLayout, QHeaderView, QPushButton, \
    QSizePolicy, QTableWidget, QTableWidgetItem, QWidget, QMainWindow
from PyQt6 import QtWidgets


class formModificarReserva(object):
    def setupUi(self, Form):
        if not Form.objectName():
            Form.setObjectName(u"Form")
        Form.resize(1120, 400)
        ...
        self.tableWidget.setEditTriggers(
            QtWidgets.QAbstractItemView.EditTrigger.AnyKeyPressed|QtWidgets.QAbstractItemView.EditTrigger.DoubleClicked|QtWidgets.QAbstractItemView.EditTrigger.EditKeyPressed)
